...
public class NetManager : ManagerBase
{
    ...
    private ClientSocket client = new ClientSocket("127.0.0.1", 6669);
    ...
    private void Update()
    {
        ...
        while (client.socketMessagesQueue.Count > 0)
        {
            SocketMessage msg = client.socketMessagesQueue.Dequeue();
            //处理消息
    ...
    /// 接受网络的消息
    /// </summary>
    private void processSocketMsg(SocketMessage msg)
    {
        switch (msg.OpCode)
        {
            case OpCode.ACCOUNT:
